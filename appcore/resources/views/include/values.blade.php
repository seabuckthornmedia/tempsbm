  ...
  <div class="row" style="">
    <div class="col-md-12">    
      <div class="align-middle" style="float:left; width:400px; margin-left:20px; margin-right:20px; ">
          ...
          <p>This is also why we love to support local community groups and keep all our websites powered by renewables.</p>
          <p>
              <a class="btn btn-primary" href="#pricing" role="button">More &raquo;</a>
          </p>
      </div>
      <img src="{{ asset('images/plant.jpg') }}" class="img-responsive" style="float:left; width:400px;border-radius:10%;" alt="Image">
    </div>
  </div>
  <br><br>
  <hr>
